...
contract FlattenedSToadzCFLR is LilOwnable, ERC721 {
    using Strings for uint256;

	uint256 public constant publicMintMaxSupply = 6000;
    uint256 public constant mintPrice = 12 ether;
    ...
    function setSRibbits(address _sRibbitsTest) external onlyOwner {
        sRibbits = _sRibbitsTest;
    }
