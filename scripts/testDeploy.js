...
const deploy = async () => {
  ...
  const setSToadzAirdropInfo = await sToadzContract.setAirdrop(
    airdropAddresses,
    airdropAmounts
  );
  ...
  // add sToadz contract address to SongBirdCity constructor
  ...
  // add sToadz contract address to LuxuryLofts constructor
